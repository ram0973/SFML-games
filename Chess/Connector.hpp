...
void ConnectToEngine(char* path)
{
   ...
   size_t len = strlen(path) + 1; //Plus null
   mbstowcs_s(&numOfCharConverted, wpath, path, len);
   LPWSTR lwpstr_path = wpath;
   CreateProcess(NULL, lwpstr_path, NULL, NULL, TRUE,0, NULL, NULL, &sti, &pi);
}
